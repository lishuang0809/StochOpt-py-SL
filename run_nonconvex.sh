    ...
    do
        ...
        do
            ...
            python3 main.py --type 1 --dataset ${DATASET[j]} --data_path "./datasets/${DATASET[j]}" \
                        --name $NAME --result_folder 'sps2_exact_max' --log_file "log-${NAME}.txt" \
                        --epochs 60 --n_repetition 1 --reg ${regs[s]} --tol 1e-2 --lamb 0.1  \
                        --loss "Logistic" --regularizer 'L2' --beta ${betas[r]} --run_SP2max True --run_SP2maxp True
                        #              --run_sps True --run_sgd True --run_SP2 True  \
  # --run_sps True --run_sgd True --run_adam True --run_sps2 True --run_sps2slack True --run_sps2 True --run_SP2L2p True --run_SP2L1p True --run_sps True --run_sgd True --run_adam True --run_SP2maxp True
